...
- $(1)$ Logical symbol for "either X is true or Y is true" is $X \lor Y$

- $(2)$ Logical symbol for "not both" is $\lnot(X \land Y)$

- $(3)$ Logical symbol for "either X is true or Y is true, /but/ not both" is $(X \lor Y) \land\lnot(X\land Y)$
...
- $\equiv$ {  By converting the logical symbols into a sentence }
